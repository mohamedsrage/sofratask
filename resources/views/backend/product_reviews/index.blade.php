...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Product Reqvews</h6>
            <div class="ml-auto">
        ...
        @include('backend.product_reviews.filiter.filiter')
                ...
                @forelse($reviews as $review)
                    <tr>
                        <td>
                            {{ $review->name }} <br>
                            {{ $review->email }} <br>
                            <small>{!! $review->user->id != '' ? $review->user->full_name : '' !!}</small>
                        </td>
                        <td>
                            {{ $review->title }}
