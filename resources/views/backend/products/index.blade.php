...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        @include('backend.products.filiter.filiter')
                    ...
                    <tr>
                      <td>
                            ...
                            @if ($product->firstMedia)
                                <img src="{{$product->firstMedia->count() > 0 ? asset('assets/products/' . $product->firstMedia->first()->file_name) : '' }}" width="60" height="60" alt="{{ $product->name }}">
                            @else
